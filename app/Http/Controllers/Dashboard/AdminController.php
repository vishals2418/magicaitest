...
class AdminController extends Controller
{
    ...
    public function adsenseList(Request $request)
    {
        if ($request->method() == 'GET') {
            ...
            if ($request->datatable == 'yes') {
                return DataTables::of($sql)
                    ...
                    ->rawColumns(['id', 'type', 'status', 'updated_at', 'action'])
                    ->make(true);
            }
        }
    }
    ...
    {
        $adsense = Adsense::whereId($id)->firstOrFail();
