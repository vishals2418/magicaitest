                ...
                <div class="col-md-12 mx-auto">
                    <div class="card overflow-hidden border-0">
                        <div class="card-header">
                            <h3 class="card-title">Edit Google Adsense Code: <span
                                    class="font-weight-bold text-primary">{{ $adsense->type }}</span></h3>
                        </div>
                        <div class="card-body pt-5">
                            <form id="update_adsense_form" onsubmit="return adsenseUpdate({{ $adsense->id }});" method="POST"
                                        ...
                                        <div class="input-box">
                                            <label class="form-check form-switch ps-0">
                                                ...
                                                <input class="form-check-input" name="status" type="checkbox"
                                                    id="status" {{ $adsense->status == 1 ? 'checked' : '' }}>
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mt-2">
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        <div class="input-box">
                                            <h6>Adsense Code <span class="text-required"><i
                                                        class="fa-solid fa-asterisk"></i></span></h6>
                                            <textarea class="form-control" name="code" rows="12" id="code" required="">{{ $adsense->code }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="border-0 text-left mb-2 mt-3">
                                    ...
                                    <button id="form_button" class="btn btn-primary">Update</button>
                                </div>
                            </form>
                        </div>
                    </div>
