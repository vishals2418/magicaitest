    ...
    Route::prefix('dashboard')->middleware('auth')->name('dashboard.')->group(function () {
        ...
        Route::prefix('admin')->middleware('admin')->name('admin.')->group(function () {
            ...
            Route::prefix('adsense')->name('adsense.')->group(function () {
                ...
                Route::get('/list', [AdminController::class, 'adsenseList'])->name('list');
                Route::post('/save', [AdminController::class, 'adsenseSave'])->name('save');
                Route::get('/edit/{id}', [AdminController::class, 'adsenseEdit'])->name('edit');
                Route::post('/update/{id}', [AdminController::class, 'adsenseUpdate'])->name('update');
